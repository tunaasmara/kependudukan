          ...
          <fieldset style="border: none;">
            ...
            <p>Keterangan</p>
              ...
              <div style="float:right">
                ...
                <p style="margin-top:120px;text-align:center"> <input type="text" name="" value="" placeholder="H. Dawam Aly, S.Sos" style="border:none; font-size:12px;text-align:center"> </p>
              </div>
              </fieldset>
    </div>
    <!-- /.modal-content -->
